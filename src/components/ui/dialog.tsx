...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-[12%] z-50 w-[min(100%-1.5rem,40rem)] -translate-x-1/2 rounded-xl bg-surface p-4 shadow-[var(--shadow-border)] outline-none md:p-5",
        className,
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      className={cn("pr-10 text-base font-medium text-fg", className)}
      {...props}
    />
  );
}
